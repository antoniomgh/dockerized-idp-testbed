 ...
 */
$metadata['https://mysample-organization/idp/shibboleth'] = array(
	'name' => array(
		'en' => 'Shibboleth IdP',
	),
	'description'          => 'Test Shibboleth IdP.',

	'SingleSignOnService'  => 'https://idptestbed.localhost/idp/profile/SAML2/Redirect/SSO',
	'SingleLogoutService'  => 'https://idptestbed.localhost/idp/profile/SAML2/Redirect/SLO',
	'certificate' => 'idp-signing.crt',
);

$metadata['https://mysample-organization/idp/simplesamlphp'] = array(
	'name' => array(
